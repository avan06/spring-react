package com.mssoftech.springreact.dbflute.cbean.cq.ciq;
...
import com.mssoftech.springreact.dbflute.cbean.cq.bs.*;
import com.mssoftech.springreact.dbflute.cbean.cq.*;

/**
 * The condition-query for in-line of user_table.
 * @author DBFlute(AutoGenerator)
 */
public class UserTableCIQ extends AbstractBsUserTableCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsUserTableCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public UserTableCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsUserTableCQ myCQ) {
    ...
    public String keepScalarCondition(UserTableCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(UserTableCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(UserTableCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(UserTableCQ sq)
    ...
    protected String xinCB() { return UserTableCB.class.getName(); }
    protected String xinCQ() { return UserTableCQ.class.getName(); }
}
