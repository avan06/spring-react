...
import com.mssoftech.springreact.dbflute.allcommon.DBFluteInitializer;
...
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.mssoftech.springreact.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.mssoftech.springreact.dbflute.allcommon.ImplementedInvokerAssistant();
    }
