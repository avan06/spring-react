...
public interface EntityDefinedCommonColumn extends Entity {
     ...
     * @return The instance of the property type. (NullAllowed)
     */
    String getRegisterProcess();

    /**
     * Set the value of registerProcess.
     * @param registerProcess The instance of the property type. (NullAllowed)
     */
    void setRegisterProcess(String registerProcess);
     ...
     * @return The instance of the property type. (NullAllowed)
     */
    String getUpdateProcess();

    /**
     * Set the value of updateProcess.
     * @param updateProcess The instance of the property type. (NullAllowed)
     */
    void setUpdateProcess(String updateProcess);
}
