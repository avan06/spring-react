package com.mssoftech.springreact.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("login", "com.mssoftech.springreact.dbflute.bsentity.dbmeta.LoginDbm");
        tmpMap.put("session", "com.mssoftech.springreact.dbflute.bsentity.dbmeta.SessionDbm");
        tmpMap.put("sys_table", "com.mssoftech.springreact.dbflute.bsentity.dbmeta.SysTableDbm");
        tmpMap.put("user_table", "com.mssoftech.springreact.dbflute.bsentity.dbmeta.UserTableDbm");
