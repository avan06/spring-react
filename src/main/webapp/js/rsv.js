...
(function() {
      ...
      switch (requirement) {
        case "required":
          if (!((fieldValue != null) && fieldValue.length > 0)) {
            rsv.processError(form[fieldName], errorMessage);
          }
          break;
        case "digits_only":
        ...
        case "length":
          ...
          break;
        case "valid_email":
          if (!((fieldValue != null) && rsv.isValidEmail(fieldValue))) {
            rsv.processError(form[fieldName], errorMessage);
          }
          break;
        case "valid_date":
          ...
          if (!rsv.isValidDate(fieldValue, form[fieldName2], form[fieldName3], isLaterDate)) {
            rsv.processError(form[fieldName], errorMessage);
          }
          break;
        case "same_as":
  ...
  rsv.processError = function(obj, message) {
    ...
    return rsv.returnHash.push([obj, message]);
  };
