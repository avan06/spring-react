...
wObj.Application = React.createClass
	...
	render: ->
		<div className="container-fixed" style={{fontSize:12,border:1,borderStyle:"solid",
		width:wObj.width,height:wObj.height,backgroundColor: "#F0F0F0"}}>
			<ReactBootstrap.Row className="darkBgLarge"
				...
				<ReactBootstrap.Col xs={5} style={{textAlign: "center"}}>ユーザーテーブル管理
				</ReactBootstrap.Col>
			...
			<ReactBootstrap.Button bsSize="xsmall" bsStyle="primary" onClick={this.handleClick}
			...
			<ReactBootstrap.Row　style={{verticalAlign:"middle", lineHeight:"26px",marginLeft:0}}>
				<ReactBootstrap.Col xs={1} style={{textAlign: "right"}}>tableName
					...
					<ReactBootstrap.Input type="text" value={this.state.search.tableName_s}
						name="search#tableName_s" onChange={this.handleChange}
						style={{height:24,fontSize:12,width:"100%"}}/>
					</ReactBootstrap.Col>
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.search.tableName_e}
					...
					<ReactBootstrap.Col xs={1} >
						<ReactBootstrap.Input type="text" value={this.state.search.maxRecord}
			...
			<ReactBootstrap.Row　style={{verticalAlign:"middle", lineHeight:"26px",marginLeft:0}}>
				<ReactBootstrap.Col xs={1} style={{textAlign: "right"}}>key1
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.search.key1_s}
						name="search#key1_s" onChange={this.handleChange}
						style={{height:24,fontSize:12,width:"100%"}}/>
					</ReactBootstrap.Col>
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.search.key1_e}
				...
				<div ref="tableBody"
					...
					<div style={{width:this.state.usertbl.totalW,overflowX:"hidden",overflowY:"hidden"}}>
						...
						onClick={this.handleClick}>
							<wObj.UsertblRows rcds={this.state.usertbl.rcds} cw={this.state.usertbl.cw}
			...
			<ReactBootstrap.Row　style={{verticalAlign:"middle", lineHeight:"26px",marginLeft:0,marginRight:5}}>
				<ReactBootstrap.Col xs={1} style={{textAlign: "right"}}>tableName
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.tableName}
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.key1}
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.key2}
			...
			<ReactBootstrap.Row　style={{verticalAlign:"middle", lineHeight:"26px",marginLeft:0,marginRight:5}}>
				<ReactBootstrap.Col xs={1} style={{textAlign: "right"}}>s1Data
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.s1Data}
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.s2Data}
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.s3Data}
			...
			<ReactBootstrap.Row　style={{verticalAlign:"middle", lineHeight:"26px",marginLeft:0,marginRight:5}}>
				<ReactBootstrap.Col xs={1} style={{textAlign: "right"}}>n1Data
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.n1Data}
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.n2Data}
					...
					<ReactBootstrap.Col xs={3}>
					<ReactBootstrap.Input type="text" value={this.state.form.n3Data}
