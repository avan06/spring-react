...
wObj.Application = React.createClass
	...
	render: ->
		<div className="container-fixed" style={{fontSize:12,border:1,borderStyle:"solid",width:800,height:600,backgroundColor: "#F0F0F0"}}>
			{### Header Area ###}
			...
			<ReactBootstrap.TabbedArea activeKey={this.state.tabkey} className="usertab" bsStyle="pills"
			onSelect={wObj.tabClick}
			style={{backgroundColor: "#FFFFFF"}}>
			{### 検索 ###}
			<ReactBootstrap.TabPane eventKey={1} tab="検索"
			...
			{### 詳細 ###}
			<ReactBootstrap.TabPane eventKey={2} tab="詳細"
			style={{border:1,borderStyle:"solid",height:535}}>
			<ReactBootstrap.Row style={{margin:5}}>
				<ReactBootstrap.Button bsSize="xsmall" bsStyle="primary" onClick={wObj.handleClick}
