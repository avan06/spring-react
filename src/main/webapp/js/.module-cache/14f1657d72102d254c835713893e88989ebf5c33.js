    ...
    render: function() {
      ...
      return (
        ...
        React.createElement("div", null, total, React.createElement("br", null), 
          React.createElement(Input, {type: "text", value: this.state.input1, placeholder: ".col-lg-1", 
                             onChange: this.handleChange.bind(this, 'input1','t')}), 
          React.createElement(Input, {type: "text", value: this.state.input2, placeholder: ".col-lg-1", 
