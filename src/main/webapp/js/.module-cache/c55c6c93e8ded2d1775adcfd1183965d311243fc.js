        ...
        React.createElement("form", {className: "form-horizontal", style: {margin:10}}, 
          React.createElement(b.Row, null, 
            React.createElement(b.Col, {xs: 1}, 
              React.createElement("div", {style: {textAlign: "right",lineHeight:"22px",verticalAlign:"middle"}, className: "vcenter"}, "TEST")
            ), 
          ...
          React.createElement(b.Row, null, 
            React.createElement(b.Col, {xs: 1}, 
              React.createElement("p", {style: {textAlign: "right",verticalAlign: "bottom"}}, "TEST")
            ), 
            React.createElement(b.Col, {xs: sieze1}, 
              React.createElement(b.Input, {type: "text", value: this.state[name1], 
                name: name1, onChange: this.handleChange, style: {height:22}})
