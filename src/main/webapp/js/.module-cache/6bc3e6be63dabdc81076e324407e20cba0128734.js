    ...
    render: function() {
      ...
      return (  
        ...
        React.createElement("p", {style: {marginLeft:30}}, total), 
            ...
            React.createElement(b.Button, {bsStyle: "primary", onClick: this.handleClick, name: "btnSearch", style: {marginLeft:30}}, "検索"), 

            React.createElement(b.Button, {bsStyle: "primary", onClick: this.handleClick, name: "btnSearch2"}, "検索"), 
