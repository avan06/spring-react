  ...
  var Application = React.createClass({displayName: 'Application',
    ...
    render: function() {
      ...
      return (  
        ...
        React.createElement("div", {className: "container-fixed", style: {fontSize:11}}, 
        React.createElement("p", {style: {marginLeft:30}}, total), 
		    React.createElement(b.Row, null, 

            React.createElement(b.Button, {bsSize: "xsmall", bsStyle: "primary", onClick: this.handleClick, name: "btnSearch", style: {marginLeft:30}}, "検索"), 

            React.createElement(b.Button, {bsSize: "xsmall", bsStyle: "primary", onClick: this.handleClick, name: "btnSearch2"}, "検索"), 

            React.createElement(b.Button, {bsSize: "xsmall", bsStyle: "primary", onClick: this.handleClick, name: "btnSearch"}, "検索"), 

            React.createElement(b.Button, {bsSize: "xsmall", bsStyle: "primary", onClick: this.handleClick, name: "btnSearch2"}, "検索")

        ), 
        React.createElement("form", {className: "form-horizontal", style: {margin:10}}, 
          React.createElement(b.Row, {style: {margin:2}}, 
            React.createElement(b.Col, {xs: 1, style: {textAlign: "right",lineHeight:"22px",verticalAlign:"middle"}}, 
              "TEST"
            ), 
            React.createElement(b.Col, {xs: sieze1}, 
              React.createElement(b.Input, {type: "text", value: this.state[name1], 
                name: name1, onChange: this.handleChange, style: {height:22}})
            )
          ), 
          React.createElement(b.Row, {style: {margin:2}}, 
            React.createElement(b.Col, {xs: 1, style: {textAlign: "right",lineHeight:"22px",verticalAlign:"middle"}}, "TEST"
            ), 
            React.createElement(b.Col, {xs: sieze1}, 
              React.createElement(b.Input, {type: "text", value: this.state[name1], 
                name: name1, onChange: this.handleChange, style: {height:22}})
		      ...
		      React.createElement("tbody", null, 
		        React.createElement("tr", {style: {height:22}}, 
		          ...
		          React.createElement("td", {style: {width: 200}}, 
								React.createElement(SelectOption, {options: optionv, style: {height:24, fontSize:11}, name: "testname", 
