  ...
  return (
      React.createElement(b.Modal, {onRequestHide: function(){}, className: "deleteCfm"}, 
        React.createElement("div", {className: "modal-body"}, "削除してよいですね"
          ...
          React.createElement("div", {className: "modal-footer"}, 
          React.createElement(b.Button, {onClick: this.props.onClick, name: "deleteCfm#YesBtn"}, "YES"), 
          React.createElement(b.Button, {onClick: this.props.onClick, name: "deleteCfm#CloseBtn"}, "NO")
          )
        )
      );
  }
