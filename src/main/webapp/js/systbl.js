...
(function() {
  ...
  $w.formSearch = function(jsx) {
    ...
    return $w.flux.actions.base_rcd_fetch(jsx.state.systbl, jsx.state.form, "systbl", criteria);
  };
  ...
  $w.formUpdate = function(jsx) {
    ...
    return $w.flux.actions.base_rcd_update(jsx.state.systbl, jsx.state.form, "systbl");
  };
  ...
  $w.formDeleteCfm = function(jsx) {
    return $w.flux.actions.base_rcd_delete(jsx.state.systbl, jsx.state.form, "systbl");
  };
